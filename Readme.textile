...
Rails cache store documentation here: http://api.rubyonrails.org/classes/ActiveSupport/Cache/Store.html

When using caching methods in Rails, there are two common cache busting techniques. One is to use a cache key that busts itself. Example:
